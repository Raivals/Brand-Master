...
const categories = {
    ...
    action: [
        { question: "The one and only who played can read this card.", answer: "Draw the Apple logo without using the iconic apple shape.", plusValue: 2, minusValue:""  },
        { question: "The one and only who played can read this card.", answer: "Hum the McDonald’s ‘I’m Lovin’ It’ jingle without saying the words ‘McDonald’s’ or ‘lovin’.’", plusValue: 3, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Describe Coca-Cola without using the words ‘red,’ ‘drink,’ or ‘soda.’", plusValue: 2, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Sketch the Nike swoosh logo without any text.", plusValue: 1, minusValue:""  },
        { question: "The one and only who played can read this card.", answer: "Act out the concept of ‘brand identity’ without speaking.", plusValue: 2, minusValue:  ""},
        { question: "The one and only who played can read this card.", answer: "Draw a dynamic logo idea for Google (no text allowed).", plusValue: 3, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Describe the term ‘vector’ without saying ‘scalable’ or ‘quality.’", plusValue: 2, minusValue:""  },
        { question: "The one and only who played can read this card.", answer: "Sing a jingle for a famous chocolate brand without naming it or the product.", plusValue: 1, minusValue:""  },
        { question: "The one and only who played can read this card.", answer: "Draw the Starbucks logo, avoiding text and the face details.", plusValue: 3, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Explain the concept of a color palette without using ‘color’ or ‘design.’", plusValue: 2, minusValue:""  },
        { question: "The one and only who played can read this card.", answer: "Act out the term ‘trademark’ without using words.", plusValue: 1, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Draw a Pepsi logo without using text or the red/blue colors.", plusValue: 2, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Make others guess ‘DPI’ by describing it without saying ‘dots,’ ‘inch,’ or ‘print.’", plusValue: 3, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Act out the phrase ‘brand style guide’ without speaking.", plusValue: 2, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Hum a tune that represents a tech company (e.g., Intel’s jingle) without naming the brand.", plusValue: 3, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Sketch the Twitter logo without using text or the bird’s face.", plusValue: 1, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Explain the term ‘secondary brand colors’ without saying ‘secondary’ or ‘colors.’", plusValue: 2, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Describe ‘brand architecture’ without saying ‘brand’ or ‘structure.’", plusValue: 3, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Draw the Adidas logo using only geometric shapes, no text.", plusValue: 1, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Explain ‘typography’ without using the words ‘font’ or ‘text.’", plusValue: 2, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Draw the FedEx logo without using text or the hidden arrow.", plusValue: 1, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Describe the term ‘raster’ without using the words ‘pixel,’ ‘image,’ or ‘grid.’", plusValue: 2, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Hum the theme music of a popular fast-food chain without naming it.", plusValue: 3, minusValue:  ""},
        { question: "The one and only who played can read this card.", answer: "Act out the concept of ‘scalable’ without speaking or drawing.", plusValue: 2, minusValue:  ""},
        { question: "The one and only who played can read this card.", answer: "Sketch a concept for a wordmark for your favorite tech brand without using letters from their name.", plusValue: 1, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Draw the FedEx logo without using text or the hidden arrow.", plusValue: 1, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Describe the term ‘raster’ without using the words ‘pixel,’ ‘image,’ or ‘grid.’", plusValue: 2, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Hum the theme music of a popular fast-food chain without naming it.", plusValue: 3, minusValue: "" },
        { question: "The one and only who played can read this card.", answer: "Act out the concept of ‘scalable’ without speaking or drawing.", plusValue: 2, minusValue: "" },
